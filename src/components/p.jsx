...
export function Experience() {
    ...
    return (
        ...
        >
            ...
            transition-all duration-300 ${visibleItems.includes(index)
                                ...
                                >
                                    ...
                                    {/* Timeline dot */}
                                    <div
                                        className={`absolute w-6 h-6 bg-green-500 rounded-full border-4 border-slate-900 shadow-lg z-10 transition-transform duration-300`}
                                        style={{
                                            left: "50%",
                                            top: "2rem",
                                                    ...
                                                    {experience.achievement.map((achv, achindex) => {
                                                        return (
                                                            <li
                                                                ...
                                                                style={{
                                                                    animationDelay: `${index * 300 + achindex * 200 + 1500
                                                                        }ms`,
                                                                }}
                                                            >
